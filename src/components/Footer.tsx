      ...
      <div className="footer-content">
        <div className="footer-section">
          <div className="footer-logo">
            ...
            <span className="app-name">Paint</span>
          </div>
          <p className="footer-tagline">
            Decentralized digital art creation on Bitcoin SV
          </p>
        </div>
        ...
        <div className="footer-section">
          <h4>Platform</h4>
          <ul>
            <li><a href="/bitcoin-paint">About</a></li>
        ...
        <div className="footer-section">
          <h4>Community</h4>
          <ul>
            <li><a href="https://github.com/bitcoin-apps-suite/bitcoin-paint" target="_blank" rel="noopener noreferrer">GitHub</a></li>
            <li><a href="https://twitter.com/bitcoin_paint" target="_blank" rel="noopener noreferrer">Twitter</a></li>
            <li><a href="https://discord.gg/xBB8r8dj" target="_blank" rel="noopener noreferrer">Discord</a></li>
            <li><a href="/token">$BPAINT Token</a></li>
          </ul>
        </div>
        ...
        <div className="footer-section">
          <h4>Marketplace</h4>
          <ul>
            <li><a href="/bitcoin-paint/exchange">NFT Exchange</a></li>
